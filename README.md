...
[![Build Status](https://img.shields.io/travis/m0r4kbitcore-wallet-service-sparks.svg?branch=master&style=flat-square)](https://travis-ci.org/m0r4kbitcore-wallet-service-sparks)
[![Coverage Status](https://coveralls.io/repos/m0r4kbitcore-wallet-service-sparks/badge.svg?branch=master)](https://coveralls.io/r/m0r4kbitcore-wallet-service-sparks?branch=master)
...
# Getting Started
```
 git clone https://github.com/sparkspaybitcore-wallet-service-sparks.git
